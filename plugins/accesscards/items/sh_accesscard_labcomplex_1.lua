...
ITEM.description = "Небольшая пластиковая карта с потёртой надписью 'ГЛАВНЫЙ ВХОД'."
...
ITEM.functions.usetarget = {
	...
	OnRun = function(item)
		...
		if (IsValid(target) and target:GetClass() == "func_door_rotating") and target:GetName() == "gate_b_button" then
